/* Icons.js — Pre-calculated SVG icons for Minair
 * This module contains pre-calculated SVG icons to avoid runtime processing
 */

export const Icons = {
    // Trash icon (16x16 with 2px stroke)
    ...
    // Search icon (16x16 with 2px stroke)
    ...
    // Plus icon (16x16 with 2px stroke)
    ...
    // Calendar icon (16x16 with 2px stroke)
    ...
    // Map pin icon (16x16 with 2px stroke)
    mapPin: `<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    ...
    // Loading spinner icon (16x16 with 2px stroke)
    loader: `<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="loading-icon">
...
export function createIconElement(iconName, className = '') {
    ...
    span.innerHTML = getIcon(iconName);
    if (className) {
